...
class ReadIncidenceMatrix:
    def __init__(self, B1: pd.DataFrame, B2: pd.DataFrame):
        """
        Args:
            B1 (pd.DataFrame): The incidence matrix B1 of dimension 2.
            B2 (pd.DataFrame): The incidence matrix B2 of dimension 3.
        """
        self.B1 = B1.values
        self.B2 = B2.values
    ...
    def number_of_nodes(self) -> int:
        """Number of nodes in the simplicial complex."""
        return self.B1.shape[0]

    def number_of_edges(self) -> int:
        """Number of edges in the simplicial complex."""
        return self.B1.shape[1]

    def number_of_triangles(self) -> int:
        """Number of triangles in the simplicial complex."""
    ...
    def get_edge_list(self, rank=None) -> list:
        if rank == 1:
    ...
    def get_triangle_nodes(self) -> list:
